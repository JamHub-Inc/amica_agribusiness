...
import { ChevronDown, ChevronRight, LogOut, Settings, Bell, HelpCircle, LayoutDashboard, Leaf, Sparkles, BarChart3, ShoppingCart, HandHelping, User as UserIcon, Megaphone, Building2 } from 'lucide-react';
...
const navItems = [
  ...
  { title: 'SACCO Affiliation', href: '/sacco-affiliation', icon: Building2 },
  { title: 'Market Demand', href: '/market-demand', icon: Megaphone},
...
const FarmerSidebar = ({ isOpen = true, setIsOpen }) => {
